  ...
  const [series] = useState([
    {
      ...
      data: [20, 15, 17, 12, 15, 24, 10, 20, 5, 18, 10, 15]
    }
  ]);
  ...
  return (
    <Box sx={{ p: 2, m: 2, border: '1px solid #e0e0e0', borderRadius: '8px' }}>
      <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={1}>
        <Typography variant="h5">Tasks Tracker</Typography>
        <IconButton
          color="secondary"
          id="symptoms-button"
      ...
      <Stack direction="row" alignItems="center" justifyContent="flex-end" spacing={0.5} sx={{ mt: 1 }}>
        ...
        <Chip color="success" variant="filled" label="High" size="small" sx={{ bgcolor: 'success.main', borderRadius: 1 }} />
      </Stack>
      <TasksChart />
    </Box>
  );
